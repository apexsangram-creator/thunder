(function ($) {
	...
	function updateHeaderHeight(){
		if($stickyBox.length && !$stickyBox.hasClass('active')){
			naturalHeaderHeight = $stickyBox.outerHeight();
			if(naturalHeaderHeight > 0){
				$stickyHeader.css('min-height', naturalHeaderHeight + 'px');
			}
		}
	}
